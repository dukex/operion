...
// func CreateChannel(logger watermill.LoggerAdapter, serviceName string) (message.Publisher, *kafka.Subscriber, error) {
// 	brokers := strings.Split(os.Getenv("KAFKA_BROKERS"), ",")
// 	if len(brokers) == 0 || brokers[0] == "" {
// 		return nil, errKafkaBrokersNotSet
// 	}
...
// 	return wotel.NewPublisherDecorator(publisher), subscriber, nil
// }
